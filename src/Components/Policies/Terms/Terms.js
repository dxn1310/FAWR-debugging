                    ...
                    <Accordion borderRadius="0.5rem" allowMultiple>
                        <AccordionItem borderRadius="0.5rem" >
                            ...
                            <AccordionPanel pb={4} backgroundColor="#e0e0e0">
                                BigDigitalMedia hereby grants you a limited, personal, non-exclusive, non-transferable, non-sublicensable, freely revocable licence to access and use the Site solely for your own personal, non-commercial, and legal purposes, provided that you maintain all copyright, trademark, and other intellectual property notices therein. This licence is subject to your continued compliance with these Terms and Conditions. Furthermore, BigDigitalMedia does not give you permission to imply or otherwise infer that BigDigitalMedia supports or endorses the political opinions, causes, ideas, goods, or services of any third party. The reserving of all other rights is clearly made here.
                                <br /><br />
                    ...
                    <Accordion borderRadius="0.5rem" allowMultiple>
                        <AccordionItem borderRadius="0.5rem">
                            ...
                            <AccordionPanel pb={4} backgroundColor="#e0e0e0">
                                ...
                                BigDigitalMedia gives no assurances of any kind for any other websites you may access through this one. Please be aware that any non-BigDigitalMedia websites you view are independent from BigDigitalMedia and that BigDigitalMedia has no control over their content, even if BigDigitalMedia has provided the website's owner with information or services. Additionally, a link to a website that is not run by BigDigitalMedia does not imply that BigDigitalMedia approves of it or assumes any liability for its usage or its content. BigDigitalMedia really disclaims all responsibility and accountability for this content. It is your responsibility to take care to make sure that everything you choose for your usage is free of harmful elements like viruses, worms, trojan horses, and other similar things.
                            </AccordionPanel>
                        </AccordionItem>
                    </Accordion>
                    ...
                    <Accordion borderRadius="0.5rem" allowMultiple>
                        <AccordionItem borderRadius="0.5rem">
                            ...
                            <AccordionPanel pb={4} backgroundColor="#e0e0e0">
                                ...
                                The "Trademarks" used and displayed on the Site, including but not limited to BigDigitalMedia®, are registered and unregistered trademarks of BigDigitalMedia. Others may own additional trademarks, service marks, logos, and trade names. No licence or right to use any Trademark or other BigDigitalMedia intellectual property displayed on the Site is granted by implication, estoppel, or any other language in the content of the Site. To the fullest extent of the law, BigDigitalMedia vigorously pursues its intellectual property rights. You may not refer to or attribute any information to BigDigitalMedia or its licensors in any public medium for promotional or advertising purposes, or otherwise, or for the purpose of persuading a third party, without the prior written consent of BigDigitalMedia. This includes using the trademark and trade name BigDigitalMedia® or any other Trademarks in advertising or publicity pertaining to the distribution of Content on the Site. Additionally, BigDigitalMedia forbids the use of BigDigitalMedia® and any other Trademarks in links to or from any websites without express written consent from BigDigitalMedia.
                            </AccordionPanel>
                        </AccordionItem>
                    </Accordion>
                    ...
                    <Accordion borderRadius="0.5rem" allowMultiple>
                        <AccordionItem borderRadius="0.5rem">
                            ...
                            <AccordionPanel pb={4} backgroundColor="#e0e0e0">
                                ...
                                You understand and agree that BigDigitalMedia is the owner of all information you post, submit, share, or otherwise publish on the Site, and that BigDigitalMedia has the unlimited right to use, publish in electronic form and other formats, distribute, and exploit any such material ("Submissions"). In connection with BigDigitalMedia's use and publishing of such Submissions, you expressly release BigDigitalMedia from any and all claims on the grounds of any claimed or real violations of any privacy or publicity rights, moral rights, rights of attribution, or any other intellectual property rights. This implies that everything you post, upload, share, or otherwise publish on the Site will become BigDigitalMedia's property and that BigDigitalMedia may use it for any reason, now or in the future, without paying you or requiring additional consent from you. Additionally, you renounce any claims against BigDigitalMedia for any real or claimed infringement of any intellectual property rights originating from or connected to the Submissions, including any claims for violation of moral rights, rights of attribution, privacy, and publicity. The authenticity or reliability of any Submissions published, uploaded, placed on any bulletin board, or otherwise transmitted through the Site by any user, information provider, or other third party is not guaranteed or endorsed by BigDigitalMedia. You understand and agree that any reliance on such Submissions shall be at your alone choice, liability, and risk. BigDigitalMedia explicitly disclaims any and all liability relating to Submissions. You promise not to upload, submit, distribute, or otherwise publish on the website any content that: (i) constitute threats, libel, defamation, or obscenity; (ii) would be a criminal crime, give rise to civil liability, or otherwise violate the law, or that encourages such behaviour; (iii) violate any third party's intellectual property, privacy, or other rights; (iv) have a virus or other harmful component; (v) include marketing; or (vi) comprise or contain assertions that are untrue or deceptive. BigDigitalMedia maintains the right, in its sole discretion, to refuse to post any information or Submission and the right to delete any such Submission, in whole or in part, from the Site for any reason.
                            </AccordionPanel>
                        </AccordionItem>
                    </Accordion>
                    ...
                    <Accordion borderRadius="0.5rem" allowMultiple>
                        <AccordionItem borderRadius="0.5rem">
                            ...
                            <AccordionPanel pb={4} backgroundColor="#e0e0e0">
                                ...
                                Information you acquire by using the Site might contain lags, omissions, or errors. You are given access to the content on the Site with the understanding that BigDigitalMedia is not offering you any advice or services about investments, consulting, law, accounting, taxes, careers, or other matters. Information on the site should not be used as a substitute for consulting with professional advisers or as a basis for business, investing, or other decisions. Furthermore, neither BigDigitalMedia nor any user, information provider, or other person or entity makes any representations as to the validity or reliability of any advice, opinion, statement, or other information that is posted, uploaded, downloaded, or otherwise made available through the Site by any of these parties. You understand and agree that any reliance on any such statement, memorandum, advice, opinion, or other information shall be at your exclusive discretion, risk, and liability. Furthermore, if your use of the Site in whole or in part implies that BigDigitalMedia supports or endorses the causes, ideologies, political campaigns, political viewpoints, websites, goods, or services of a third party, BigDigitalMedia does not offer you any licence or other authority to use the Site in any way.
                            </AccordionPanel>
                        </AccordionItem>
                    </Accordion>
                    ...
                    <Accordion borderRadius="0.5rem" allowMultiple>
                        <AccordionItem borderRadius="0.5rem">
                            ...
                            <AccordionPanel pb={4} backgroundColor="#e0e0e0">
                                ...
                                The website and all of its content are offered "as is" and "as available" with no warranties of any kind.  DISCLAIMS ALL WARRANTIES, EXPRESS, IMPLIED, STATUTORY OR OTHERWISE, INCLUDING, BUT NOT LIMITED TO, WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, TITLE AND NON-INFRINGEMENT, TO THE FULLEST EXTENT PERMISSIBLE UNDER APPLICABLE LAW. Without limitation, BigDigitalMedia DOES NOT REPRESENT OR WARRANT THAT, IN PARTICULAR, (1) The information on the website is accurate, reliable, and correct; (2) The website's functions must be uninterrupted or error-free; or (3) DEFECTS SHALL BE CORRECTED, OR THAT VIRUSES OR OTHER HARMFUL COMPONENTS ARE NOT PRESENT ON THE WEBSITE OR THE SERVER THAT MAKES IT AVAILABLE.
                            </AccordionPanel>
                        </AccordionItem>
                    </Accordion>
                    ...
                    <Accordion borderRadius="0.5rem" allowMultiple>
                        <AccordionItem borderRadius="0.5rem">
                            ...
                            <AccordionPanel pb={4} backgroundColor="#e0e0e0">
                                ...
                                Under no circumstances will BigDigitalMedia or any of its predecessors, successors, parents, subsidiaries, affiliates, officers, directors, shareholders, investors, employees, agents, representatives, attorneys, and each of their respective heirs, successors, and assigns, be liable for any damages, including direct, incidental, punitive, special, consequential, or exempt damages resulting from the use of, or inability to use, the site or the information, content, or materials. Even if BigDigitalMedia has been informed of the likelihood of such damages, use of the site, including for viruses allegedly received from the site, may result in legal action under any theory of responsibility, including contract, tort (including negligence), strict liability, or other theories. This waiver covers all damages or injuries, including those brought on by theft, destruction, unauthorized access to, alteration of, or use of any record, as well as errors, omissions, interruptions, deletions, defects, delays in operation or transmission, computer viruses, corrupted files, communication-line issues, network or system outages.
                                <br /><br />
                                In no event shall BigDigitalMedia or any of its predecessors, successors, parents, subsidiaries, affiliates, officers, directors, shareholders, investors, employees, agents, representatives, and attorneys, and each of their respective heirs, successors, and assigns, total liability to you for all damages, losses, and causes of action, whether in contract, tort (including, but not limited to, negligence), or otherwise, exceed $1. Any jurisdictions might not permit the exclusion of implied warranties, in which case all users might not be covered by some of the aforementioned exclusions.
                            </AccordionPanel>
                        </AccordionItem>
                    </Accordion>
                    ...
                    <Accordion borderRadius="0.5rem" allowMultiple>
                        <AccordionItem borderRadius="0.5rem">
                            ...
                            <AccordionPanel pb={4} backgroundColor="#e0e0e0">
                                ...
                                Regardless of any issues of conflict of law, these terms and conditions are governed by and construed in accordance with the laws of the Commonwealth of Massachusetts in the United States of America. You hereby explicitly consent to the Commonwealth of Massachusetts' courts having sole jurisdiction over any disputes. Furthermore, you agree and fully consent to the Commonwealth of Massachusetts exercising personal jurisdiction over any dispute or claim involving BigDigitalMedia. The validity and enforceability of the other terms shall not be affected if any portion of these Terms and Conditions may be or become void, illegal, or unenforceable.
                            </AccordionPanel>
                        </AccordionItem>
                    </Accordion>
                    ...
                    <Accordion borderRadius="0.5rem" allowMultiple>
                        <AccordionItem borderRadius="0.5rem">
                            ...
                            <AccordionPanel pb={4} backgroundColor="#e0e0e0">
                                ...
                                Any information that violates a person's or organization's copyright or other intellectual property rights, including their right to privacy and publicity, is not permitted to be posted by BigDigitalMedia. You should inform BigDigitalMedia of your copyright infringement claim in line with the following manner if you think any content on the Site violates your copyright or other intellectual property rights. BigDigitalMedia is obligated under the Digital Millennium Copyright Act to process notices of suspected infringement and take necessary action ("DMCA"). The Site's Designated Agent, who is: is required to receive notices of alleged copyright infringement under the DMCA.
                                <br /><br />
                                Person Name,<br />
                                BigDigitalMedia(BigDigitalMedia), <br />
                                Address-<br />
                                Email: <br />
                    ...
                    <Accordion borderRadius="0.5rem" allowMultiple>
                        <AccordionItem borderRadius="0.5rem">
                            ...
                            <AccordionPanel pb={4} backgroundColor="#e0e0e0">
                                ...
                                All earlier or contemporaneous understandings or agreements, whether written or oral, regarding the subject matter of these Terms and Conditions are superseded and replaced by these Terms and Conditions, which serve as the complete agreement between you and BigDigitalMedia with respect to that subject matter. Any waiver of any of these terms and conditions must be in writing and signed by BigDigitalMedia to be valid. Any failure to enforce a term or condition shall not be construed as a waiver of any subsequent violation of that or any other term or condition.
                            </AccordionPanel>
                        </AccordionItem>
                    </Accordion>
                </Stack>
